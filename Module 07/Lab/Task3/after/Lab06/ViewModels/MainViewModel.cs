...
namespace Lab06.ViewModels
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Parameters passed to BLAST service
        /// </summary>
        public IList<KeyValue> BlastParameters { get; private set; }
        ...
        /// <summary>
        /// True to use Browser proxy
        /// </summary>
        public bool UseBrowserProxy
        {
            get { return _useBrowserProxy; }
            set { _useBrowserProxy = value; OnPropertyChanged("UseBrowserProxy"); }
        }
